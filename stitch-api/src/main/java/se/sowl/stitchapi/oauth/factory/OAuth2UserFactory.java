package se.sowl.stitchapi.oauth.factory;
...
import se.sowl.stitchdomain.oauth.domain.OAuth2Profile;
import se.sowl.stitchdomain.oauth.domain.OAuth2UserAttribute;
import se.sowl.stitchdomain.oauth.domain.Role;
